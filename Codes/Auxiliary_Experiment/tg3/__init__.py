...
class Player(BasePlayer):
    ...
    M1M2 = models.IntegerField(
        choices=[[1, '非常不满意'], [2, '不满意'], [3, '比较不满意'], [4, '一般'], [5, '比较满意'], [6, '满意'],
                 [7, '非常满意']], label=f"如果你选择A，你的收入为 {C.R1_1A}，对手收入为 {C.R2_1A}",
        widget=widgets.RadioSelect)
    N1N2 = models.IntegerField(
        choices=[[1, '非常不满意'], [2, '不满意'], [3, '比较不满意'], [4, '一般'], [5, '比较满意'], [6, '满意'],
                 [7, '非常满意']], label=f'如果你选择B，对手选择E，你的收入为{C.R1_1B2E}，对手收入为{C.R2_1B2E}',
        widget=widgets.RadioSelect)
    N3N4 = models.IntegerField(
        choices=[[1, '非常不满意'], [2, '不满意'], [3, '比较不满意'], [4, '一般'], [5, '比较满意'], [6, '满意'],
                 [7, '非常满意']], label=f'如果你选择B，对手选择F，你的收入为{C.R1_1B2F}，对手收入为{C.R2_1B2F}',
        widget=widgets.RadioSelect)
    M2M1 = models.IntegerField(
        choices=[[1, '非常不满意'], [2, '不满意'], [3, '比较不满意'], [4, '一般'], [5, '比较满意'], [6, '满意'],
                 [7, '非常满意']], label=f'如果对手选择A，你的收入为{C.R2_1A}，对手收入为{C.R1_1A}',
        widget=widgets.RadioSelect)
    N2N1 = models.IntegerField(
        choices=[[1, '非常不满意'], [2, '不满意'], [3, '比较不满意'], [4, '一般'], [5, '比较满意'], [6, '满意'],
                 [7, '非常满意']], label=f'如果对手选择B，你选择E，你的收入为{C.R2_1B2E}，对手收入为{C.R1_1B2E}',
        widget=widgets.RadioSelect)
    N4N3 = models.IntegerField(
        choices=[[1, '非常不满意'], [2, '不满意'], [3, '比较不满意'], [4, '一般'], [5, '比较满意'], [6, '满意'],
                 [7, '非常满意']], label=f'如果对手选择B，你选择F，你的收入为{C.R2_1B2F}，对手收入为{C.R1_1B2F}',
        widget=widgets.RadioSelect)
...
def set_payoff(player):
    ...
    participant.tg3payoff = player.payoff
...
def set_guess_payoffs(group:Group):
    for play in group.get_players():
        ...
        participant.tg3guess = guess1 + guess2
