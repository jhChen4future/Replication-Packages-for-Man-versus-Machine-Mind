...
class Constants(BaseConstants):
    ...
    sucker_payoff = 10
    defector_payoff = 40
    INSTRUCTIONS_TEMPLATE = 'Repeated_PD4/instructions.html'
...
class Results_Page_R1(Page):
    ...
    def before_next_page(player, timeout_happened):
        ...
        if player.round_number == 1:
            participant.pd4 = 0
            participant.pd4 = participant.pd4 + player.payoff
        else:
            participant.pd4 = player.payoff + participant.pd4
        print(participant.pd4)
        print(player.payoff)
