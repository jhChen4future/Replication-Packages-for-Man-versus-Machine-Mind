...
class Constants(BaseConstants):
    ...
    sucker_payoff = 10
    defector_payoff = 40
    INSTRUCTIONS_TEMPLATE = 'Repeated_PD5/instructions.html'
...
class Results_Page_R1(Page):
    ...
    def before_next_page(player, timeout_happened):
        ...
        if player.round_number == 1:
            participant.pd5 = 0
            participant.pd5 = participant.pd5 + player.payoff
        else:
            participant.pd5 = player.payoff + participant.pd5
        print(participant.pd5)
        print(player.payoff)
