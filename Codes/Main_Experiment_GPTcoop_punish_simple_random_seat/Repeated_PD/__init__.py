...
class Constants(BaseConstants):
    ...
    sucker_payoff = 10
    defector_payoff = 40
    INSTRUCTIONS_TEMPLATE = 'Repeated_PD/instructions.html'
...
class Player(BasePlayer):
    ...
    Train1 = models.IntegerField(
        label='问题1：假设玩家1选择A，玩家2选择B，玩家1本轮的收入是多少？')
    Train2 = models.IntegerField(
        label='问题2：假设玩家1选择A，玩家2选择A，玩家2本轮的收入是多少？')
    Train3 = models.IntegerField(
        label='问题3：假设玩家1选择B，玩家2选择A，玩家1本轮的收入是多少？')
    Train4 = models.IntegerField(
        label='问题4：假设玩家1选择B，玩家2选择B，玩家2本轮的收入是多少？')
...
class Results_Page_R1(Page):
    ...
    def before_next_page(player: Player, timeout_happened):
        ...
        if player.round_number == Constants.num_rounds:
            ...
            participant.pd1 = player.payoff
            participant.pd1_round = player.round_to_pay
    '''
    @staticmethod
    def before_next_page(player, timeout_happened):
        ...
        if player.round_number == 1:
            participant.pd1 = 0
            participant.pd1 = participant.pd1 + player.payoff
        else:
            participant.pd1 = player.payoff + participant.pd1
...
page_sequence = [LabelInitiate,  Introduction,Train, WaitforStart, LabelResults, Decision_R1_P1, Decision_R1_P2, R1_WaitPage, Waitforallgroups, Results_Page_R1,Results_round]