...
class Constants(BaseConstants):
    ...
    sucker_payoff = 10
    defector_payoff = 40
    INSTRUCTIONS_TEMPLATE = 'Repeated_PD6/instructions.html'
...
class Results_Page_R1(Page):
    ...
    def before_next_page(player, timeout_happened):
        ...
        if player.round_number == 1:
            participant.pd6 = 0
            participant.pd6 = participant.pd6 + player.payoff
        else:
            participant.pd6 = player.payoff + participant.pd6
        print(participant.pd6)
        print(player.payoff)
