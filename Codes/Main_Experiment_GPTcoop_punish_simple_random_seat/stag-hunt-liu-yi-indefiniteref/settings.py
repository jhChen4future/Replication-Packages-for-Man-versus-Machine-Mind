...
SESSION_CONFIGS = [
    dict(
        ...
        app_sequence=['attachmentecon', 'attachment_Trust', 'attachment_Ultimatum', 'payment_info'],
    ),
    dict(
        name='trust_simple',
        display_name='Simple Trust',
        num_demo_participants=2,
...
SECRET_KEY = '^-1c%t)cn^=n-h$4bi=%9f&bzth@s9@75n&zj(nou*f3w2#s#+'
