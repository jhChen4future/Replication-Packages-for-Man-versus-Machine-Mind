...
class Constants(BaseConstants):
    ...
    sucker_payoff = 10
    defector_payoff = 40
    INSTRUCTIONS_TEMPLATE = 'Repeated_PD7/instructions.html'
...
class Results_Page_R1(Page):
    ...
    def before_next_page(player, timeout_happened):
        ...
        if player.round_number == 1:
            participant.pd7 = 0
            participant.pd7 = participant.pd7 + player.payoff
        else:
            participant.pd7 = player.payoff + participant.pd7
        print(participant.pd7)
        print(player.payoff)
